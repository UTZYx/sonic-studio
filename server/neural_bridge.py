...
class GenerationRequest(BaseModel):
    ...
    top_k: int = Field(250, ge=1, le=5000, description="Top K sampling (1-5000)")
    temperature: float = Field(1.0, ge=0.01, le=5.0, description="Sampling temperature (0.01-5.0)")
