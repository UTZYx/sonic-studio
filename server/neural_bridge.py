...
# SECURITY: Restrict origins to prevent unauthorized access
...
class GenerationRequest(BaseModel):
    prompt: str = Field(..., max_length=1000)
    type: Literal["music", "sfx"] = "music"
    size: str = "small"
    layers: list[LayerConfig | str] | None = Field(None, max_length=10)
...
async def generate(req: GenerationRequest):
    try:
        ...
        # SECURITY: Return generic error to prevent leaking stack traces
