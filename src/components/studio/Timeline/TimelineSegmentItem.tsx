...
import { Copy, Repeat, Trash2, Wand2, Zap } from "lucide-react";
import React, { memo } from "react";
import { TimelineLayer, TimelineSegment } from "./types";
...
interface TimelineSegmentItemProps {
    ...
    addLayer: (segmentId: string) => void;
    removeLayer: (segmentId: string, layerId: string) => void;
}
