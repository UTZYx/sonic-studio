...
import { Copy, Trash2, Zap, Wand2, Repeat } from "lucide-react";
...
export const TimelineItem = React.memo(({ segment, onUpdate, onRemove, onDuplicate, onGenerate }: TimelineItemProps) => {
