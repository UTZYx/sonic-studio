...
import { Trash2, Copy, Zap, Wand2, Repeat, Layers } from "lucide-react";
...
const TimelineItem = memo(({ segment, onUpdate, onRemove, onDuplicate, onGenerate }: TimelineItemProps) => {
            ...
            <div className="p-2 border-t border-white/5 flex items-center justify-between bg-black/20">
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className={`p-1.5 rounded-lg hover:bg-white/10 transition-colors ${segment.layers && segment.layers.length > 0 ? "text-cyan-400" : "text-neutral-500 hover:text-white"}`}
                        title="Toggle Layers"
                    >
