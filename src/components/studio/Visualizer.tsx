...
function Waveform({ analyser }: { analyser: AnalyserNode | null }) {
    ...
    // Optimization: Reuse Color object to avoid GC churn in useFrame loop
    ...
    useFrame((state) => {
        ...
        for (let i = 0; i < count; i++) {
            ...
            colorScratch.setHSL(0.5 + (freq * 0.3), 1, 0.5 + freq * 0.5);
            mesh.current.setColorAt(i, colorScratch);
        }
