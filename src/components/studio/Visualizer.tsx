...
function Waveform({ analyser }: { analyser: AnalyserNode | null }) {
    ...
    // Optimization: Reuse a single THREE.Color instance to avoid 7k+ allocations/sec in the render loop
    ...
    useFrame((state) => {
        ...
        for (let i = 0; i < count; i++) {
            ...
            // Reusing the 'color' object here is safe as setColorAt copies values
